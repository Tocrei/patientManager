...
<html lang="en">
	...
	<body>
		...
		<div class="panel panel-default">
			<div class="container">
				<div class="panel-heading"><span class="baja">Formulario de baja</span></div>
				<div class="panel-body">
			
					<form id="form_registrarse" action="borrado.php" method="post" onsubmit="return eliminado();">
						<fieldset>
							<legend>
								Indroduce DNI
							</legend>
							<table class="tabla-form" id="datos">
								...
								<tr>
									<td>
									<input type="submit" class="btn-aceptar-baja" id="sub" value="Dar de baja">
									</td>
									<td> </td>
								</tr>
