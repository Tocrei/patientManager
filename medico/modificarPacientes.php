				...
				<table class="table table-striped table-bordered table-hover" data-method="POST">
					<thead>
						<tr>
							...
							<th>DNI Paciente</th>
							<th class="btn-peticion">Modificar </th>
						</tr>
					</thead>
					<tbody data-link="row" class="rowlink">
						...
						foreach ($cursor as $documento) {
							echo "<form id='form_algo' name='form' action='modificarPaciente.php' method='post'>";
								echo "<tr>";
									...
									echo "<td class='celda btn-peticion'><input type='submit'  name='lupa' id='info' value='&#xf040' class='btn btn-info btn-ancho'></td>";
								echo "</tr>";
							echo "</form>";
							$t = $t+1;	
						}	
